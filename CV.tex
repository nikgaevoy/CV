...
\begin{tabularx}{\textwidth}{lX}
	2023~-- Present & PhD at the Technion~-- Israel Institute of Technology, Israel \\
	2021~-- 2025 & PhD in Mathematics at Saint Petersburg University, Russia, \href{https://math-cs.spbu.ru/en/advanced-mathematics/}{program ``Advanced Mathematics''} \\
...
\begin{tabularx}{\textwidth}{lX}
	2021~-- 2022 & Junior Researcher at the Euler International
...
\begin{itemize}
	\item \bibentry{ResPlus26}
	\item \bibentry{Intersection26}
	\item \bibentry{Seaweed25}
...
\begin{tabularx}{\textwidth}{lX}
	...
	2015~-- 2022 & Guest lecturer and teaching assistant at the Mathematics Club at Physics and Mathematics Lyceum \#30 \\

	2018~-- 2022 & Guest lecturer and teaching assistant at the Programming Club at Physics and Mathematics Lyceum \#30
\end{tabularx}
...
\begin{tabular}{ll}
	...
	CPHoF & \href{https://cphof.org/profile/codeforces:nikgaevoy}{{\it Nikita Gaevoy}}
\end{tabular}

\section*{Contribution to Open Source}

\begin{itemize}
  \item \href{https://github.com/nikgaevoy/seaweed}{Rust library} of algorithms on strings using sticky braids. Implements the \href{https://doi.org/10.4230/LIPIcs.CPM.2025.13}{doubly-periodic string comparison} algorithm and others.

  \item \href{https://github.com/nikgaevoy/SPbTrueSkill}{Rust implementation} of the improved version of TrueSkill, which was used as base for other implementation for \href{https://arxiv.org/abs/2101.00400}{research projects}.
\end{itemize}

\section*{Programming Skills}

Rust, C++, Python, Java (+ Android), Lean 4.
